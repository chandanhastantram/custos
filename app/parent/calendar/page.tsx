...
export default function ParentCalendarPage() {
  ...
  const events = [
    { date: '2026-01-18', title: 'Math Test (Alice)', time: '10:00 AM', type: 'exam', child: 'Alice' },
    { date: '2026-01-20', title: 'Science Fair', time: '9:00 AM', type: 'event', child: 'Both' },
    { date: '2026-01-22', title: 'PTM', time: '02:00 PM', type: 'meeting', child: 'Both' },
    { date: '2026-01-25', title: 'Republic Day', time: 'All Day', type: 'holiday', child: 'Both' },
  ];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">View events and important dates</p>
        </div>
        <select
          value={selectedChild}
          ...
          <div className="relative bg-card rounded-xl p-6">
            ...
            <div className="grid grid-cols-7 gap-2">
              {Array.from({ length: 35 }, (_, i) => {
                ...
                return (
                  <div key={i} className={`aspect-square rounded-lg flex flex-col items-center justify-center text-sm ${
                    !isCurrentMonth ? 'text-muted-foreground/30' : hasEvent ? 'bg-blue-500/20' : 'hover:bg-muted cursor-pointer'
                  }`}>
                    {isCurrentMonth ? day : ''}
